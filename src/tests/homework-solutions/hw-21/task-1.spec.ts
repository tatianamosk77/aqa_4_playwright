...
import userData from "C:/Users/moskv/aqa_4_playwright/src/data/demo-login-form/register.data.ts";

test.describe("[Demo Login Form] [Negative checks] Registration", () => {
    ...
    for (const { title, credentials, message } of userData) {
        test(title, async ({ page }) => {
            ...
            const messageLabel = registerForm.locator("h4");
